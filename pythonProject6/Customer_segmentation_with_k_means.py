#İŞ PROBLEMİ
#Kural tabanlı müşteri segmentasyonu yöntemi RFM ile makine öğrenmesi yöntemi olan
#K-Means'in müşteri segmentasyonu için karşılaştırılması beklenmektedir
...
import tkinter
print("tkinter başarıyla içe aktarıldı.")
